...
const TeacherEducatorTemplate = ({
  ...
  const featuredSkills =
    visibleSkills.length > 0
      ...
      : ['Lesson Planning', 'Student Engagement', 'Classroom Leadership'];
  ...
  const learningFlow = [
    {
      title: 'Plan',
      body: 'Design lessons with clear learning goals.',
    },
    {
      title: 'Teach',
      body: 'Create engaging classroom experiences.',
    },
    {
      title: 'Support',
      body: 'Guide learners with patience and structure.',
    },
    {
      title: 'Grow',
      body: 'Improve outcomes through feedback.',
    },
  ];
  ...
  return (
    <div
      ...
      className="mx-auto bg-amber-50 p-[2mm] text-slate-900 shadow-xl"
      style={{
        width: '210mm',
        minHeight: '297mm',
        boxSizing: 'border-box',
        fontFamily: bodyDesign.fontFamily,
        '--teacher-accent': accentColor,
      }}
    >
      <div className="min-h-[293mm] overflow-hidden rounded-[18px] border border-amber-200 bg-white shadow-sm">
        {/* HEADER */}
        <header
          className="relative overflow-hidden px-[5mm] py-[4mm]"
          style={{
            background: `linear-gradient(135deg, ${accentColor}14 0%, #ffffff 62%)`,
          }}
        >
          <div
          ...
          <div className="relative z-10 grid grid-cols-[1fr_46mm] items-start gap-4">
            <div>
              ...
              {hasValue(profile.fullName) && (
                <h1 className="mt-2 text-[27px] font-black leading-tight tracking-[-0.04em] text-slate-950">
                  {profile.fullName}
                </h1>
              )}
            ...
            {hasContact && (
              <div className="rounded-xl border border-amber-200 bg-white/90 p-2.5 text-[9px] font-semibold leading-4 text-slate-600 shadow-sm [&_p]:break-words">
        ...
        {/* LEARNING FLOW */}
        <section className="grid grid-cols-4 border-y border-amber-200">
        ...
        <div className="grid grid-cols-[1fr_42mm] gap-4 px-[5mm] py-[4mm]">
          {/* MAIN LETTER */}
          <main>
            <section className="mb-3 flex items-center gap-2 border-b border-amber-200 pb-2.5">
              <span
            ...
            {/* BODY */}
            <section className="rounded-2xl border border-amber-100 bg-white px-4 py-3 shadow-[0_10px_26px_rgba(120,53,15,0.035)]">
              <Body
                body={body}
                design={bodyDesign}
            ...
            <section className="mt-3 grid grid-cols-3 gap-2.5">
              <ValuePillar
                title="Learning"
                body="Builds clarity, curiosity, and confidence."
                accentColor={accentColor}
              />

              <ValuePillar
                title="Care"
                body="Supports diverse learners with structure."
                accentColor={accentColor}
              />

              <ValuePillar
                title="Growth"
                body="Uses feedback to improve outcomes."
                accentColor={accentColor}
              />
            </section>
          ...
          <aside>
            ...
            {/* EDUCATOR PROFILE */}
            <section className="mt-4 rounded-xl border border-amber-200 bg-white px-3 py-3 shadow-sm">
              <p
              ...
              <p className="mt-2 text-[9.5px] font-semibold leading-4 text-slate-600">
                A warm, structured teaching profile focused on learning design,
                student support, classroom leadership, and growth.
              </p>
            </section>
              ...
              <section className="mt-4">
                ...
                <div className="mt-3 space-y-2">
                  {featuredSkills.map((skill, index) => (
                    <div
                      key={`${skill}-${index}`}
                      className="rounded-xl border border-amber-200 bg-white px-3 py-2.5 shadow-sm"
                    >
...
const LearningStep = ({ index, title, body, accentColor }) => (
  <div className="border-r border-amber-200 bg-amber-50 px-3 py-3 last:border-r-0">
    <p
...
export default TeacherEducatorTemplate;
