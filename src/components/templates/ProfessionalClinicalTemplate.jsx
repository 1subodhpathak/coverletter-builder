...
const ProfessionalClinicalTemplate = ({
  body = '',
  design = {},
  profile = {},
  signature = {},
  ...
  const featuredSkills =
    visibleSkills.length > 0
      ? visibleSkills
      : ['Patient Care', 'Clinical Communication', 'Team Collaboration'];
  ...
  return (
    <div
      ...
      className="mx-auto bg-[#f8fffd] text-slate-900 shadow-xl"
      style={{
        width: '210mm',
        minHeight: '297mm',
        ...
        '--clinical-accent': accentColor,
      }}
    >
      <div className="min-h-[289mm] rounded-[18px] border border-teal-100 bg-white px-8 py-7 shadow-sm">
        {/* HEADER */}
          ...
          <div className="flex items-start justify-between gap-5">
            <div>
              ...
              {(hasValue(profile.currentJobTitle) || featuredSkills.length > 0) && (
                <p className="mt-2 max-w-[135mm] text-[11px] font-semibold leading-4 text-slate-600">
            ...
            <div
              className="mt-1 h-1.5 w-20 rounded-full"
        ...
        {/* DATE + RECIPIENT */}
        <section className="mt-4 grid grid-cols-[34mm_1fr] gap-5 rounded-xl border border-teal-100 bg-teal-50/60 px-4 py-3">
        ...
        <main className="mt-5 rounded-2xl border border-slate-100 bg-white px-4 py-4 shadow-[0_10px_26px_rgba(15,23,42,0.035)]">
          <Body
            ...
            className="
              ...
              prose-strong:text-[var(--clinical-accent)]
              [&>*:first-child]:mt-0
              [&>*:last-child]:mb-0
            "
          />
...
export default ProfessionalClinicalTemplate;